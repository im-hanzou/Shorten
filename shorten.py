...
m, h, k, b, n = '\033[1;31m', '\033[1;32m', '\033[1;33m', '\033[1;34m', '\033[0m'
...
if __name__ == '__main__':
    os.system('clear')
    print(f'{m}╔═╗{n}┬ ┬┌─┐┬─┐┌┬┐┌─┐┌┐┌')
    print(f'{m}╚═╗{n}├─┤│ │├┬┘ │ ├┤ │││{b}  ⟥{n} Author:{h} Budhe Errucha')
    print(f'{m}╚═╝{n}┴ ┴└─┘┴└─ ┴ └─┘┘└┘{b}  ⟥{n} Version:{m} 1.0')
    print(f'{n}        ╰────────────────────────────')
    print()
    print(f'   {m}-{b} Options')
    ...
    print()
    print(f'{m}!{n}Please select number')
    ask = input(f'{m}>>>> {n}')
    if ask not in ['1','2','3','4','5','6','7','8','9']:
        exit(f'{m}!{n}Undefined option: {ask}')

    print()
    print(f'{m}!{n}Please input your long url')
    print(f'{m}!{n}use {h},{n} for separator if there are many urls')
    url = input(f'{m}>>>> {b}').replace(' ','').split(',')
    print()
    print(f'{m}!{n}Result')
    if ask == '1' or ask == '01':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{shorturl_at(urls)}')
    elif ask == '2' or ask == '02':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{shorturl_asia(urls)}')
    elif ask == '3' or ask == '03':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{is_gd(urls)}')
    elif ask == '4' or ask == '04':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{cut_ly(urls)}')
    elif ask == '5' or ask == '05':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{tiny_cc(urls)}')
    elif ask == '6' or ask == '06':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{in_run(urls)}')
    elif ask == '7' or ask == '07':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{surl_li(urls)}')
    elif ask == '8' or ask == '08':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{urlxz_com(urls)}')
    elif ask == '9' or ask == '09':
        for urls in url: print(f'{b}➺{m}[{h}+{m}]{n} {urls} {b}>> {n}{shorter_me(urls)}')
